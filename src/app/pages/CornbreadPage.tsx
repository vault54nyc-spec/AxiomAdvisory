...
import { Lock, ArrowRight, Instagram, TrendingUp, Eye, EyeOff, FileText } from "lucide-react";
...
export default function CornbreadPage() {
  ...
  const LockedSection = ({ title }: { title: string }) => (
    <div className="relative cursor-pointer group" onClick={() => setShowLockModal(true)}>
      ...
      <div className="p-8 border border-gray-100 select-none opacity-30">
        ...
        return (
          <div className="space-y-10">
            <div className="space-y-2">
              ...
              <h2 className="text-4xl font-bold text-[#0A0A0A]" style={{ fontFamily: "'Playfair Display', serif" }}>The Landscape</h2>
              <p className="text-gray-400 text-sm italic">Prepared following a strategic introduction through a mutual connection within the organization.</p>
            </div>
            ...
            <div className="bg-[#0A0A0A] p-8 space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  { n: "01", title: "The Infrastructure Gap", body: "The brand has the product. The audience is ready. What's missing is the operational backbone to scale without fracturing." },
                  { n: "02", title: "The Consistency Problem", body: "Four locations. Four different customer experiences. Closing that gap is the single highest-leverage move available right now." },
                  { n: "03", title: "The Narrative Opportunity", body: "The \"Farm-to-Soul\" story is powerful and largely untold. The market is waiting for a brand to own this space at scale." },
                ].map((item) => (
        ...
        return (
          <div className="space-y-10">
            <div className="space-y-2">
              ...
              <h2 className="text-4xl font-bold text-[#0A0A0A]" style={{ fontFamily: "'Playfair Display', serif" }}>The Architecture</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-50 border border-gray-100 p-8 space-y-4">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">This is an embedded strategic partnership — one that operates at the intersection of brand, operations, and executive decision-making.</p>
                <p className="text-gray-600 text-sm leading-relaxed">The result is a brand that doesn't just look ready to scale. It actually is.</p>
              </div>
            </div>
            <LockedSection title="Proprietary KPI Dashboard & Execution Roadmap" />
          </div>
        );
        ...
        return (
          <div className="space-y-10">
            <div className="space-y-2">
              ...
              <h2 className="text-4xl font-bold text-[#0A0A0A]" style={{ fontFamily: "'Playfair Display', serif" }}>The Vision</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="space-y-4">
                ...
                <div className="relative overflow-hidden shadow-lg">
                  <img src="https://pub-d271817665684c82ae385a9c153ff8fa.r2.dev/image.jpg" alt="The Future of Cornbread" className="w-full object-cover" />
            ...
            <LockedSection title="AI Social Media Engine: Prompt Chains & Content Workflows" />
          </div>
        );
          ...
          <div className="space-y-10">
            <div className="space-y-2">
              <p className="text-[11px] uppercase tracking-[0.2em] text-[#D4AF37] font-bold flex items-center gap-2">
                <FileText size={12} /> Strategic Intelligence
              </p>
              <h2 className="text-4xl font-bold text-[#0A0A0A]" style={{ fontFamily: "'Playfair Display', serif" }}>Brand & Growth Report</h2>
              <p className="text-gray-500 text-sm">Cornbread Soul Food — February 2026 · Strategic Brand Advisory Team</p>
            </div>

            {/* Page 1 Preview — Executive Summary */}
            <div className="border border-gray-100 p-8 sm:p-10 space-y-6">
              <div className="flex items-center justify-between">
                <p className="text-[11px] uppercase tracking-[0.2em] text-[#D4AF37] font-bold">Executive Summary</p>
                <span className="text-[10px] text-gray-300 uppercase tracking-widest">Page 1 of 65</span>
              </div>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                Cornbread Soul Food represents a compelling fast-casual concept positioned at the intersection of cultural authenticity and modern dining convenience. Founded by Adenah Bayoh and Elzadie Smith in 2017, the brand has grown from a single Maplewood, NJ location to four thriving locations across New Jersey and New York — establishing itself as a pioneering force in the emerging fast-casual soul food segment.
              </p>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                The brand operates within a <strong>$4.22 billion global soul food restaurant market</strong> growing at 6.7% CAGR, projected to reach $7.63 billion by 2033. With strong foundational elements including a "farm-to-soul" positioning, proprietary mobile app, tech-forward operations, and franchising ambitions, Cornbread is well-positioned for significant expansion.
              </p>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                This analysis identifies critical opportunities across seven key dimensions: digital presence, customer experience, competitive positioning, operational excellence, market expansion, technology integration, and brand storytelling.
              </p>
              <div className="bg-[#F9F7F3] p-6 space-y-3">
                <p className="text-[11px] uppercase tracking-widest text-gray-400 font-bold">Key Findings</p>
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    "Strong cultural positioning with authentic \"farm-to-soul\" narrative",
                    "Digital infrastructure exists but underutilized for brand building",
                    "Inconsistent customer experience across locations",
                    "Significant white space in fast-casual soul food nationwide",
                    "Franchise-ready model with potential to scale rapidly",
                  ].map((f, i) => (
            ...
            {/* Page 2 Preview — Brand Identity */}
            <div className="border border-gray-100 p-8 sm:p-10 space-y-6">
              <div className="flex items-center justify-between">
                <p className="text-[11px] uppercase tracking-[0.2em] text-[#D4AF37] font-bold">Current Brand Identity Analysis</p>
                <span className="text-[10px] text-gray-300 uppercase tracking-widest">Page 2</span>
              </div>
              <div className="grid sm:grid-cols-2 gap-8">
                <div>
                  <p className="font-bold text-[#0A0A0A] text-sm mb-3">Digital Presence — Strengths</p>
                  <div className="space-y-2">
                    {["Clean, modern design aligned with fast-casual positioning", "Mobile app promotion prominently featured", "\"Farm-to-soul\" messaging present"].map((s, i) => (
                      <div key={i} className="flex items-start gap-2">
                ...
                <div>
                  <p className="font-bold text-[#0A0A0A] text-sm mb-3">Critical Gaps</p>
                  <div className="space-y-2">
                    {["Limited SEO optimization — missing dish-level pages", "Minimal brand storytelling depth", "No consistent visual identity system", "No blog or content hub"].map((s, i) => (
                      <div key={i} className="flex items-start gap-2">
            ...
            {/* Page 3 Preview — Social Media */}
            <div className="border border-gray-100 p-8 sm:p-10 space-y-6">
              <div className="flex items-center justify-between">
                <p className="text-[11px] uppercase tracking-[0.2em] text-[#D4AF37] font-bold">Social Media Presence</p>
                <span className="text-[10px] text-gray-300 uppercase tracking-widest">Page 3</span>
              </div>
              <div>
                <p className="font-bold text-[#0A0A0A] text-sm mb-1">Instagram (@cornbreadsoul)</p>
                <p className="text-gray-600 text-sm leading-relaxed mb-4">The brand maintains an active Instagram presence with food photography and location updates. However, the analysis reveals significant opportunities for improvement.</p>
                <div className="space-y-2">
                  {[
                    { label: "Inconsistent Posting Frequency", desc: "Best practices suggest 3–5 feed posts weekly plus 5–7 Stories daily. Current cadence appears irregular." },
                    { label: "Limited UGC Strategy", desc: "Soul food is inherently shareable and photogenic. A systematic UGC campaign with branded hashtags is a high-leverage opportunity." },
                    { label: "Missing Visual Identity System", desc: "No consistent color palette, typography guidelines, or visual language documented across touchpoints." },
                  ].map((item, i) => (
            ...
            {/* Locked remainder */}
            <div className="relative cursor-pointer group" onClick={() => setShowLockModal(true)}>
              <div className="absolute inset-0 backdrop-blur-[10px] bg-white/40 z-10 flex flex-col items-center justify-center gap-3 border border-dashed border-gray-200 group-hover:bg-white/30 transition-all">
                <Lock className="text-[#D4AF37]" size={28} />
                <div className="text-center">
                  <p className="text-sm font-bold text-[#0A0A0A] tracking-widest uppercase">62 Pages Remaining</p>
                  <p className="text-[11px] text-gray-500 mt-1">Full competitive analysis, customer sentiment, digital strategy, and execution roadmap</p>
                </div>
                <div className="px-6 py-2.5 bg-[#0A0A0A] text-white text-xs font-bold tracking-widest mt-2 hover:bg-gray-800 transition-colors">
                  UNLOCK FULL REPORT
                </div>
              </div>
              <div className="p-8 border border-gray-100 select-none opacity-25 space-y-4">
                <p className="font-bold text-[#0A0A0A]">Competitive Landscape Analysis</p>
                <div className="space-y-2">
                  {[100, 85, 70, 90].map((w, i) => <div key={i} className="h-3 bg-gray-200 rounded" style={{ width: `${w}%` }} />)}
                </div>
                <p className="font-bold text-[#0A0A0A] mt-6">Customer Sentiment Analysis</p>
                <div className="space-y-2">
                  {[100, 80, 60].map((w, i) => <div key={i} className="h-3 bg-gray-200 rounded" style={{ width: `${w}%` }} />)}
                </div>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="max-w-2xl mx-auto space-y-12 py-8 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
              {["Marketing Infrastructure Build-out","Operational Alignment Across Locations","Brand Governance & Standards","Third-Party & Vendor Risk Oversight","Crisis Management Protocols","Executive-Level Strategic Advisory"].map((item, i) => (
            ...
            <div className="bg-[#F9F7F3] p-8 space-y-2">
